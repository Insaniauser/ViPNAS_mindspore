...
# param_dict = load_checkpoint("vipnas_mbv3_coco_256x192-cc43b466_20210624.ckpt")
# param_dict = load_checkpoint("vipnas_res50_coco_256x192-cc43b466_20210624.ckpt")
param_dict = load_checkpoint("checkpoints209.ckpt")
