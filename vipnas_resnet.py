...
class ViPNAS_Bottleneck(nn.Cell):
    ...
    def __init__(self,
        ...
        super(ViPNAS_Bottleneck, self).__init__()
...
class ViPNAS_ResLayer(nn.SequentialCell):
    ...
    def __init__(self,
        ...
        super(ViPNAS_ResLayer, self).__init__(*layers)
        self.layers = layers
...
class ViPNAS_ResNet(nn.Cell):
    ...
    def __init__(self,
        ...
        # Protect mutable default arguments
        norm_cfg = copy.deepcopy(norm_cfg)
        super(ViPNAS_ResNet, self).__init__()
...
def kaiming_init(module,
    ...
    if hasattr(module, 'weight') and module.weight is not None:
        if distribution == 'uniform':
            ...
            # module.weight = initializer(Constant(bias), module.weight.shape, mindspore.float32)
        else:
            he_normal = HeNormal(
                negative_slope=a, mode=mode, nonlinearity=nonlinearity)
